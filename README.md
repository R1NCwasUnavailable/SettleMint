...
![SettleMint Dashboard](./public/demo.png) *(Dashboard Empty State)*
<br>
![SettleMint Dashboard in Action](./public/demo2.png) *(The deterministic math engine perfectly calculating debts based on NLP input!)*
